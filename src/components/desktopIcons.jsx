...
import "./styles.scss";
import { Shell32133, Explorer103, CdMusic, Mspaint, User } from "@react95/icons";

function Shortcuts({ openPortfolio, openCV, openTunes, openPaint, openCalendar, openGoogleAuth, isAuthenticated, userImage }) {
  return (
